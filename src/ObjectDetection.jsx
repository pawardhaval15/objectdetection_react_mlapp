...
const ObjectDetection = () => {
  ...
  //A state container isWebcamStarted is used to store the state of the webcam feed. Two functions, startWebcam and stopWebcam are used to start and stop the webcam feed.
